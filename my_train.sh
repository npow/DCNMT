...
source_language=fr
target_language=en
source_data="giga-fren.release2.fr"
target_data="giga-fren.release2.en"
src_val="giga-fren.release2.fr"
trg_val="giga-fren.release2.en"
src_test="giga-fren.release2.fr"
trg_test="giga-fren.release2.en"
src_vocab_size=120
trg_vocab_size=120
...
if [ ! -f $source_data ]; then
    echo "no such source dataset file: $source_data"
    exit -1
fi
...
sed -i '.orig' "s/--src_lang--/$source_language/" configurations.py
sed -i '.orig' "s/--trg_lang--/$target_language/" configurations.py
sed -i '.orig' "s/--src_vocab_size--/$src_vocab_size/" configurations.py
sed -i '.orig' "s/--trg_vocab_size--/$trg_vocab_size/" configurations.py
sed -i '.orig' "s/--src_val--/$src_val/" configurations.py
sed -i '.orig' "s/--trg_val--/$trg_val/" configurations.py
sed -i '.orig' "s/--src_test--/$src_test/" configurations.py
sed -i '.orig' "s/--trg_test--/$trg_test/" configurations.py
